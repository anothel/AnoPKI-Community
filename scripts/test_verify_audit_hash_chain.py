...
"""Self-checks for the audit hash-chain drill."""
...
RUNNER = ROOT / "scripts" / "verify-audit-hash-chain.py"
SPEC = importlib.util.spec_from_file_location("audit_hash_chain_drill", RUNNER)
...
def main() -> None:
    with tempfile.TemporaryDirectory() as dirname:
        ...
        written = json.loads((root / "out" / "audit-chain-verification.json").read_text(encoding="utf-8"))
    ...
    print("audit hash-chain drill tests passed: 5")
