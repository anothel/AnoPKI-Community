...
python scripts\verify-authorization-boundary.py --out-dir .tmp\authorization-boundary-evidence\full
...
python scripts\verify-postgres-multi-node-failover.py --out-dir .tmp\postgres-multi-node-failover-evidence\full
